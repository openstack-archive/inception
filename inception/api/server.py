...
class AsyncOrchestrator(threading.Thread):
    ...
    def _make_orchestrator(self, d):
        ...
        return Orchestrator(
            ...
            # TODO(AJF): end-to-end transport of userdata
...
class InceptionCloud(Base):
    ...
    def to_dict(self):
        ...
        def hexOrNone(id):
            # TODO(AJF): be more careful with db input so that all ids are of
            # same type and this function can be simplified/eliminated.
            if id is None:
                return id
